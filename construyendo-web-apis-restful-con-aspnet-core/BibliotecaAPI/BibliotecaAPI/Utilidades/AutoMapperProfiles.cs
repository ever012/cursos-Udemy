    ...
    public class AutoMapperProfiles : Profile
    {
        public AutoMapperProfiles()
        {
            CreateMap<Autor, AutorDTO>()
                .ForMember(dto => dto.NameCompleto,
            ...
            CreateMap<AutorCreacionDTOConFoto,Autor>()
                .ForMember(ent => ent.Foto, ConfigurationBinder => ConfigurationBinder.Ignore());
            ...
            CreateMap<AutorLibro, AutorDTO>()
                ...
                .ForMember(dto => dto.NameCompleto, config => config.MapFrom(ent => MapearNombreYApellidoAutor(ent.Autor!)));
