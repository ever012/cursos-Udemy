...
namespace BibliotecaAPI.Controllers.V1
{
    ...
    public class RootController : ControllerBase
    {
        ...
        public async Task<IEnumerable<DatosHATEOASDTO>> Get()
        {
            ...
            datosHATEOAS.Add(new DatosHATEOASDTO(Enlace: Url.Link("ObtenerAutoresV1", new { })!, Descripcion: "aurores-obtener", Metodo: "GET"));
            
            datosHATEOAS.Add(new DatosHATEOASDTO(Enlace: Url.Link("ObtenerUsuarioV1", new { })!, Descripcion: "usuarios-obtener", Metodo: "GET"));
