...
namespace BibliotecaAPI.Controllers.V1
{
    ...
    [Route("api/v1/autores")] //ruta del controlador
    [Authorize]
    public class AutoresController : ControllerBase
    {
        ...
        [HttpGet("{id:int}", Name = "ObtenerAutorV1")] // api/autores/1    (este se llama parametro de ruta)
        [AllowAnonymous]
        ...
        public async Task<ActionResult<AutorConLibrosDTO>> Get([Description("El Id del Autor")]int id)
        {
            ...
            //GenerarEnlaces(autorDTO);  //ya no se usa porque ahora se usa el ServiceFilter
            return autorDTO;

            
        }
        /*private void GenerarEnlaces(AutorDTO autorDTO)   //YA NO SE USA PORQUE AHORA SE USA "HATEOASAutoresAttribute"
        {
            ...
            autorDTO.Enlaces.Add(new DatosHATEOASDTO(Enlace: Url.Link("PatchAutorV1", new { id = autorDTO.Id })!, Descripcion: "autor-patch", Metodo: "PATCH"));
        ...
        [HttpPost("contenedor-foto",Name ="CrearAutorConFotoV1")]
